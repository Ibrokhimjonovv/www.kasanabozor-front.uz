  ...
  const slides = [
    {
      id: 1,
      heroText:
        "Kasanachilikni rivojlantirish bu sohada yangi imkoniyatlar yaratishdir",
      description:
        "Loyiha haqida ko'proq ma'lumot berish uchun, uning maqsadlari, vazifalari va kutilayotgan natijalari haqida batafsil",
            ...
            <SwiperSlide key={index}>
              <div className="swiper-cont">
                  ...
                  <div className="hero-text">
                    ...
                    <div className="line">
                      ...
                      <div className="name-work">
                        ...
                        <span className="work">{slide.job}</span>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="swiper-right">
                  ...
                  <div className="name-work mob-ver">
                    <span className="name">{slide.name}</span>
                    <span className="work">{slide.job}</span>
                  </div>
                </div>
