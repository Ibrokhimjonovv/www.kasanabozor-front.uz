...
const HeroSwiper = () => {
  ...
  // Ref for custom navigation buttons
  ...
  const backgroundStyle = {
    ...
    backgroundSize: "cover", // Rasmni to'liq joylashtirish
    backgroundRepeat: "no-repeat",
    backgroundPosition: "center",
    width: "100%",
  };

  // Matnni so'zlarga bo'lish va boshidagi 2 ta so'zni o'zgartirish
                    ...
                    <div className="custom-pagination">
                      {slides.map((_, index) => (
                        <span
                          ...
                          onClick={() => swiperRef.current.swiper.slideToLoop(index)} // `slideToLoop` infinite loop bilan ishlaydi
                        ></span>
                      ))}
                    </div>
                    </div>
