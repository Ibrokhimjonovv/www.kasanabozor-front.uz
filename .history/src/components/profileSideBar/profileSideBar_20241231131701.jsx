      ...
      <ul>
        ...
        <li>
          <Link
            ...
            className={activeLink === "likdannounce" ? "active" : ""}
            onClick={() => handleClickLink("announce")}
          >
            <svg
              width="24"
              height="24"
        ...
        <li>
          <Link
            to="/profile/saved-announce"
            className={activeLink === "savedAnnounce" ? "active" : ""}
            onClick={() => handleClickLink("savedAnnounce")}
          >
            <svg
              width="24"
              height="24"
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clip-path="url(#clip0_1423_21184)">
                <path
