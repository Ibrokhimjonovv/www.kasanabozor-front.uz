  ...
  return (
    <div id='kasanaTypes'>
        <div className="left-side">
            <h1><span>Kasana.uz</span> dagi imkoniyatlaringiz</h1>
            <ul>
                <li ref={ref1} className={`li ${inView1 ? "visible" : ""}`}>
                    ...
                    <div className="text">
                        ...
                        <p>Mahsulotlarni ko’rish va sotib olish jarayoni juda qulay. Siz turli xil mahsulotlarni ko’rib chiqib, kerakli narsalarni osongina tanlashingiz mumkin.</p>
                    </div>
                </li>
                <li ref={ref2} className={`li ${inView2 ? "visible" : ""}`}>
                    ...
                    <div className="text">
                        ...
                        <p>Ish e’lonlarini berish va kuzatish jarayonini kengaytirish, ishga qabul qilishni yaxshilash va ish beruvchilar bilan ish izlovchilar o'rtasida aloqani o'rnatish muhimdir.</p>
                    </div>
                </li>
                <li ref={ref3} className={`li ${inView3 ? "visible" : ""}`}>
                    ...
                    <div className="text">
                        ...
                        <p>Sohada mavjud yangiliklar haqida qisqacha ma'lumot beramiz. Bu yangiliklar sizning qiziqishingizni oshirishi mumkin.</p>
                    </div>
                </li>
                <li ref={ref4} className={`li ${inView4 ? "visible" : ""}`}>
                    ...
                    <div className="text">
                        ...
                        <p>Juda katta kurslar bazasi, ahol különböző tantárgyakat és témákat tanulmányozhatunk, hogy fejlesszük tudásunkat és készségeinket.</p>
                    </div>
                </li>
            </ul>
        </div>
        <div className="k-right-side">
            ...
            <div ref={ref4} className={`cub ${inView1 ? "visible" : ""}`}>
                ...
                <p>{inView4 && <Counter start={0} end={8000000} duration={2000} />}</p>
