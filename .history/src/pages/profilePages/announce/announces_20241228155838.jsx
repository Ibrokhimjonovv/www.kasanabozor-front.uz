...
const Announces = () => {
  ...
  const nextPage = () => {
    if (currentPage < Math.ceil(announannouncements.length / usersPerPage))
  ...
  const totalPages = Math.ceil(announannouncements.length / usersPerPage);
            ...
            <div className="pagination">
              <div className="users-pages-buttons">
                ...
                <button
                  onClick={nextPage}
                  disabled={
                    currentPage === Math.ceil(announce.length / usersPerPage)
                  }
                >
                  <img src={right} alt="" />
                </button>
