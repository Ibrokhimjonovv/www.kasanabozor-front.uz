      ...
      <div className="profile-inner">
        ...
        <div className="right">
          ...
          <form action="">
            ...
            {/* Chegirma inputlari faqat checked bo'lsa ko'rinadi */}
      {isChecked && (
        <div className="input-row">
          <div className="inputs">
          ...
          <div className="inputs">
            ...
            {/* {isChecked && (
              <div className="input-row cheg-row">
                <div className="inputs cheg-inp">
                <label htmlFor="discount">Chegirma foizi</label>
                  <input type="text" placeholder="Foizni raqamda kiriting" />
                </div>
                <div className="inputs cheg-inp">
                  <label htmlFor="final-price">So'nggi narx</label>
                  <div className="past-price"></div>
                </div>
              </div>
            )} */}
            <div className="input-row">
