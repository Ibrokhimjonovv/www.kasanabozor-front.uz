...
const MyAnnounces = () => {
      const { annou } = useContext(MyContext);
  ...
  const currentAnnounces = announces.slice(indexOfFirstUser, indexOfLastUser);
                ...
                <tr key={index}>
                  ...
                  <td>
                    <img
                      ...
                      src={announce.productImg}
                      alt=""
                    />
                  </td>
                  <td>{announce.productTitle}</td>
                  <td className="td-category"><span>{announce.category}</span></td>
                  <td>{announce.price} UZS</td>
                  <td>
                    <StarRating rating={announce.rating} />
                  </td>
                  <td>
                    <input
                      type="checkbox"
