...
const AdminSubcategories = () => {
  ...
  const products = [
    {
      id: 1,
      img: profileImg,
      category: "#Subkategoriya",
      icon: img,
      categoryLink: "#Kategoriya",
      products: 96,
      status: true,
    },
    {
  ...
  useEffect(() => {
    if (offCanvas) {
      ...
      document.body.style.overflow = 'auto'; // Yoki 'scroll' bo'lishi mumkin
    }
  ...
  return (
    <div id="admin-sub-categories">
      <Dashboard />
      <div className={`admin-item ${isOpen ? "wd" : ""}`}>
        <h2 className="title">Subkategoriyalar</h2>
                  ...
                  <div className="input-row">
                    ...
                    <div className="inputs">
                      ...
                      <select name="category" id="status">
                        <option value="">Birinchi kategoriya</option>
                        <option value="">Ikkinchi kategoriya</option>
                      </select>
                    </div>
                ...
                <tr key={index}>
                  ...
                  <td>
                    <Link to="#">
                      ...
                      >
                        <path
                          d="M6.13411 0H4.13411C2.29611 0 0.800781 1.49533 0.800781 3.33333V5.33333C0.800781 6.06867 1.39878 6.66667 2.13411 6.66667H6.13411C6.86945 6.66667 7.46745 6.06867 7.46745 5.33333V1.33333C7.46745 0.598 6.86945 0 6.13411 0ZM2.13411 5.33333V3.33333C2.13411 2.23067 3.03145 1.33333 4.13411 1.33333H6.13411V5.33333H2.13411ZM10.1341 6.66667H14.1341C14.8694 6.66667 15.4674 6.06867 15.4674 5.33333V3.33333C15.4674 1.49533 13.9721 0 12.1341 0H10.1341C9.39878 0 8.80078 0.598 8.80078 1.33333V5.33333C8.80078 6.06867 9.39878 6.66667 10.1341 6.66667ZM10.1341 1.33333H12.1341C13.2368 1.33333 14.1341 2.23067 14.1341 3.33333V5.33333H10.1341V1.33333ZM6.13411 8H2.13411C1.39878 8 0.800781 8.598 0.800781 9.33333V11.3333C0.800781 13.1713 2.29611 14.6667 4.13411 14.6667H6.13411C6.86945 14.6667 7.46745 14.0687 7.46745 13.3333V9.33333C7.46745 8.598 6.86945 8 6.13411 8ZM4.13411 13.3333C3.03145 13.3333 2.13411 12.436 2.13411 11.3333V9.33333H6.13411V13.3333H4.13411ZM16.6054 14.862L14.9121 13.1687C15.2614 12.6413 15.4674 12.0113 15.4674 11.3333C15.4674 9.49533 13.9721 8 12.1341 8C10.2961 8 8.80078 9.49533 8.80078 11.3333C8.80078 13.1713 10.2961 14.6667 12.1341 14.6667C12.8121 14.6667 13.4421 14.4607 13.9694 14.1113L15.6628 15.8047C15.7928 15.9347 15.9634 16 16.1341 16C16.3048 16 16.4754 15.9347 16.6054 15.8047C16.8661 15.544 16.8661 15.1227 16.6054 14.862ZM10.1341 11.3333C10.1341 10.2307 11.0314 9.33333 12.1341 9.33333C13.2368 9.33333 14.1341 10.2307 14.1341 11.3333C14.1341 12.436 13.2368 13.3333 12.1341 13.3333C11.0314 13.3333 10.1341 12.436 10.1341 11.3333Z"
                          fill="#41A58D"
                        />
                      </svg>

                      <span>{product.categoryLink}</span>
                    </Link>
                  </td>
