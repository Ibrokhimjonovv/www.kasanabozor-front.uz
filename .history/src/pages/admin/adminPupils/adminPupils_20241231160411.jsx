...
const AdminPupils = () => {
  ...
  const totalPages = Math.ceil(pupils.length / usersPerPage);
        ...
        <div className="users-list">
          <div className="tool">
            ...
            <div className="tool-right">
              ...
              <Link to="/dashboard/admin/add-pupils">+</Link>
            </div>
          </div>
          ...
          {totalPages > 1 && (
            <div className="pagination">
              <div className="soni">
                {pupils.length} tadan {startUserIndex} - {endUserIndex} lar
                ko’rsatilmoqda
              </div>
              <div className="users-pages-buttons">
                ...
                <button
                  onClick={nextPage}
                  disabled={
                    currentPage === Math.ceil(pupils.length / usersPerPage)
                  }
                >
                  <img src={right} alt="" />
                </button>
