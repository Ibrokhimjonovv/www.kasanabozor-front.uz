...
const Offers = () => {
  const { recommendedProducts } = useContext(OnlineShopContext);
  const [moreRecommendedProducts, setMoreRecommendedProducts] = useState([]);
  ...
  const loadMore = () => {
    setLoading(true);
    setTimeout(() => {
      setMoreRecommendedProducts([...moreRecommendedProducts, ...recommendedProducts]);
      setLoading(false);
    }, 2000);
  };
