              ...
              <li className="dropdown" style={{ backgroundColor: "#29997F" }}>
                ...
                >
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g clipPath="url(#clip0_1247_25184)">
                      <path
          ...
          <div className="details">
            <div className="detail">
              <ul>
                ...
                {categories.map((value) => (
                  <li key={value.id}>
                    <Link to={`/online-shop/categories/${value.id}/`}>
                      {value.title}
                    </Link>
                  </li>
                ))}
            ...
            <div className="detail">
              <ul>
                ...
                {newsCategories.map((value) => (
                  <li key={value.id}>
                    <Link to={`/news/categories/details/${value.id}/`}>
                      {value.title}
                    </Link>
                  </li>
                ))}
            ...
            <div className="detail">
              <ul>
                <li>{t("Documents")}</li>
                <li>
                  <Link to={"/news/documents/@a/"}>{t("Legislation")}</Link>
                </li>
                <li>
                  <Link to={"/news/documents/@b/"}>{t("Legal documents")}</Link>
                </li>
              </ul>
            </div>
            <div className="detail">
              <ul>
                <li>{t("Online lessons")}</li>
                {courseCategories.map((value) => (
                  <li key={value.id}>
                    <Link to={`/courses/categories/details/${value.id}/`}>
                      {value.title}
                    </Link>
                  </li>
                ))}
            ...
            <div className="detail">
              <ul>
                ...
                <li>
                  <Link
                    to={`/announcements/_/details/${announcements[0]?.id}/`}
                  >
                    {t("Jobs")}
                  </Link>
                </li>
                <li>
                  <Link
                    to={`/announcements/services/details/${services[0]?.id}/`}
                  >
                    {t("Services")}
                  </Link>
                </li>
          ...
          <div className="mob-menu-bottom">
            {isAuthenticated && user.role === "admin" && (
              <>
                ...
                <Link
                  to={isAuthenticated ? "/profile/messages" : "/auth/sign-in/"}
                >
                  <span>
                    <svg
                      width="24"
            ...
            {/* <Link
              id="to-profile"
              to={isAuthenticated ? "/profile/menus" : "/auth/sign-in/"}
            >
            ...
            {isAuthenticated ? (
              ...
              <Link id="to-profile" to="/auth/sign-in/">
                Kirish
              </Link>
            )}
          </div>
