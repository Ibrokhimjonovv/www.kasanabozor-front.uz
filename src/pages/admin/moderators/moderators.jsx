...
<<<<<<< HEAD:src/pages/moderators/moderators.jsx
...
>>>>>>> 8586c269379f3c97b10b691a7aea5ca55ee175ce:src/pages/admin/moderators/moderators.jsx
...
const Moderators = () => {
  ...
  const fetchData = async () => {
    const usersListResults = await axios.post(`${usersServerUrl}dashboard/users/list/mod/`);
    if (usersListResults.data.status === "ok") {
      setUsers(usersListResults.data.results);
    }
  }
  ...
  return (
    <div id="admin-moderators-users">
      ...
      <div className={`admin-item ${isOpen ? "wd" : ""}`}>
        <h2 className="title">Moderatorlar</h2>
