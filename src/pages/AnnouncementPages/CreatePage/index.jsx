    ...
    <div id="addAnnounce" className="add-announce-container">
      <div className="to-back add-announce-mobile-version">
        <div className="backInner">
          ...
          <Link to="/announcements/create/">E'lonlar berish</Link>
          <span>
            <svg
              width="16"
              height="16"
      ...
      <div className="announceSelect">
        ...
        <Link to="/announcements/create/" id="addAnn-link">
          <svg
            width="21"
            height="20"
            viewBox="0 0 21 20"
            ...
            <div className="inputs">
              <div className="input-icon">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clipPath="url(#clip0_1335_19575)">
                    <path
            ...
            <div className="input-col">
              ...
              <div className="input-icon">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clipPath="url(#clip0_1335_21921)">
                    <path
            ...
            <div className="input-icons">
              ...
              {/* <button type="button">
                ...
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clipPath="url(#clip0_1335_26060)">
                    <path
