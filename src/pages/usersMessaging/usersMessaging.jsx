    ...
    <div>
      {usersChats.length > 0 ? (
        <div id="chatbox">
          <div
            className={`chat-left ${
              fullChatScreen ? "small-width" : activeChat || activeChat === 0 ? "mob-chat-left" : ""
            }`}
          >
          ...
          <div className={`chat-right ${fullChatScreen ? "active" : activeChat || activeChat === 0 ? "mob-chat-right" : ""}`}>
            {activeChat !== null ? (
              <>
                <div className="top">
                  <div className="top-left">
                    <button
                      id="btn1"
                      className={`desktop-chat-btn ${fullChatScreen ? "btn-active" : ""}`}
