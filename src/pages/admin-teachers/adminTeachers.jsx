...
const AdminTeachers = () => {
  ...
  const totalPages = Math.ceil(teachers.length / usersPerPage);
        ...
        <div className="users-list">
          ...
          {totalPages > 1 && (
            <div className="pagination">
              <div className="soni">
                {teachers.length} tadan {startUserIndex} - {endUserIndex} lar
                ko’rsatilmoqda
              </div>
              <div className="users-pages-buttons">
                ...
                <button
                  onClick={nextPage}
                  disabled={
                    currentPage === Math.ceil(teachers.length / usersPerPage)
                  }
                >
                  <img src={right} alt="" />
                </button>
