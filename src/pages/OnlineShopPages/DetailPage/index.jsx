  ...
  const loadProductData = async () => {
    try {
      const productsResponse = await axios.post(
        `${eCommerseServerUrl}products/exact/`,
        { id: parseInt(id) },
      ...
      if (
        productsResponse.data.product.product_image_Ecommerce_product_images
      ) {
        setImages(
          productsResponse.data.product.product_image_Ecommerce_product_images
        );
  ...
  const handleConnect = async (e) => {
    ...
    const response = await axios.post(`${messagingServerUrl}api/connect/`, {
      ...
      boundary: JSON.stringify({
        data: { id: product.id },
        url: `${eCommerseServerUrl}products/exact/`,
      }),
    });
        ...
        <div className="about-product">
              ...
              <div className="images">
                <div className="vertical-images">
                  {images?.map((image, index) => (
                    <img
                      key={index}
                      src={`${mediaServerUrl}ecommerse${formatLink(
                        image.image
                      )}`}
                      alt={`Image ${index + 2}`}
          ...
          <div className="texts">
            ...
            <div className="price">
              ...
              <span
                className={product.price_off ? "newPrice active" : "newPrice"}
              >
                {product.price_off
            ...
            <div className="with-author">
              <div className="author">
                <img
                  src={`${mediaServerUrl}users${formatLink(product.user.pfp)}`}
                  alt=""
                />
                <div className="text">
                  <div className="name">
              ...
              >
                <div className="product">
                  <div className="imgContainer">
                    <img
                      src={similarProduct.product_image_Ecommerce_product_images[0] ? `${mediaServerUrl}ecommerse${formatLink(similarProduct.product_image_Ecommerce_product_images[0].image)}` : whenImageIsNotUploaded }
                      alt="..."
                    />
                  </div>
