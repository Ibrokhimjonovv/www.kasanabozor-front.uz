...
import TopCourses from "../../../components/TopCoursesComponent/topCourses";
import HistoryOfSuccess from "../../../components/HistoryOfSuccessComponent/historyOfSuccess";
import ProTeachers from "../../../components/GoodTeachersComponent/goodTeachers";
import SuggestCourses from "../../../components/SuggestCoursesComponent/suggestCourses";
            ...
            <Link to={`/courses/course/${course.id}`} key={index}>
              ...
              >
                <div className="card-img">
                  <img
                    src={`${mediaServerUrl}courses${formatLink(
                      course.thumbnail
                    )}`}
                    alt={course.title}
                  />
